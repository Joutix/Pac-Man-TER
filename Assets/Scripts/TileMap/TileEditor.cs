...
public class TileEditor : MonoBehaviour {
    ...
    protected string tilesPath = "Sprites/Skin/Default/tiles";
    ...
    void Start () {
        ...
        tileMat = new TileMatrix(hauteur, largeur, transform.position, "Sprites/Skin/Default/tiles", 10);
        //tileMat = new TileMatrix("Sprites/Skin/Default/tiles", transform.position);
        //loadLvl("test");
        UpdateText();
        initCursor();
        CenterCamera();
    ...
    public void playLvlo(string map)
    {
        PlayerPrefs.SetString("lien", "Maps/" + map + ".map"+ "/");
        SceneManager.LoadScene("Jouer");
    }
